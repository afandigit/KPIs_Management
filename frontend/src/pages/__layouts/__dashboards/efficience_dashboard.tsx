...
const EfficienceDashboard = (props: EfficienceDashboardType) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const dates = await axios.get(
        "http://127.0.0.1:5000/sql/efficience/efficience_unique_dates"
      );
  ...
  // useEffect(() => {
  //   (async () => {
  //     const url_base = "http://127.0.0.1:5000/sql/predict_efficience/";
  ...
  //     const predicted_efficience = await axios.get(url);
  //     setPredictedEfficienceData(predicted_efficience.data.data);
  //   })();
  // }, [selectedProjects]);
  ...
  useEffect(() => {
    (async () => {
      ...
      const url_base =
        "http://127.0.0.1:5000/sql/efficience_full_data/" +
        branchObjetMatching?.url_extension_dashboard;
