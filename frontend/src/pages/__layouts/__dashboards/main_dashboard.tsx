...
const MainDashboard = (props: MainDashboardType) => {
  ...
  useEffect(() => {
    (async () => {
      // OEE Urls
      const oee_last_week_data_url = "http://127.0.0.1:5000/sql/oee/lastWeek";
      const oee_the_week_befor_the_last_week_data_url =
        "http://127.0.0.1:5000/sql/oee/week_befor_lastWeek";
      const average_oee_last_week_data_url =
        "http://127.0.0.1:5000/sql/average/oee/lastWeek";
      const number_of_cutting_area_machines_url =
        "http://127.0.0.1:5000/sql/oee/number_machines/lastWeek";
      // TOP 5 URLs
      const top_5_downtime_machines_url =
        "http://127.0.0.1:5000/sql/oee/top5/downtime/lastWeek";

      const top_5_oee_machines_url =
        "http://127.0.0.1:5000/sql/oee/top5/oee/lastWeek";

      // Efficience Urls
      const efficience_last_week_data_url =
        "http://127.0.0.1:5000/sql/average/efficience/lastWeek";
      const efficience_week_befor_last_week_data_url =
        "http://127.0.0.1:5000/sql/average/efficience/weekbeforlastWeek";
      const production_hours_last_week_data_url =
        "http://127.0.0.1:5000/sql/average/productionHours/lastWeek";
      const production_hours_week_befor_last_week_data_url =
        "http://127.0.0.1:5000/sql/average/productionHours/weekBeforelastWeek";
      const averages_efficience_last_week_data_url =
        "http://127.0.0.1:5000/sql/averages/efficience/lastWeek";
      const production_hours_per_family_efficience_last_week_and_beforlastWeek_data_url =
        "http://127.0.0.1:5000/sql/production_hours_per_project/efficience/lastWeek_and_beforlastWeek";
      const production_hours_per_responsible_efficience_last_week_and_beforlastWeek_data_url =
        "http://127.0.0.1:5000/sql/production_hours_per_responsible/efficience/lastWeek_and_beforlastWeek";
      // ----------------------------------------------------------
